...
import { completeTask, getTaskView, launchMep, startTask, toggleAction, type Mep, type TaskDefinition, type TaskStatus } from '../lib/mep';
...
export default function Home() {
  ...
  const addTask = () => { const id = crypto.randomUUID(); editDefinition((definition) => definition.tasks.push({ id, title: 'Nouvelle tâche', description: '', plannedDurationSeconds: 300, dependsOn: [], actions: [], links: [] })); setSelectedTaskId(id); };
